...
class StripePaymentProcessorTest extends TestCase
{
    ...
    public function test_creates_payment_intent_successfully(): void
    {
        // Note: This test would require mocking Stripe SDK
        // For now, we test the structure
        $this->assertTrue($this->processor->requiresPaymentIntent());
    }
