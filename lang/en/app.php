...
return [
  ...
  'forms' => [
    'offer' => [
      ...
      'basic_information_description' => 'Upload an offer image and set the status',
      'image' => 'Offer Image',
      'status' => 'Status',
      'products_selection' => 'Products Selection',
      'products_selection_description' => 'Select products with specific variants and colors for this offer',
      ...
      'quantity' => 'Quantity',
      'discount' => 'Discount',
      'discount_description' => 'Set the discount for this offer',
      'products_total_price' => 'Products Total Price',
      'products_total_price_help' => 'This will be calculated automatically based on selected products',
      'offer_price' => 'Offer Price',
      'offer_price_help' => 'Enter the final price for this offer (total price will be calculated automatically)',
      'remove_product_confirm' => 'Remove Product',
      'remove_product_description' => 'Are you sure you want to remove this product from the offer?',
  ...
  'messages' => [
    ...
    'review' => [
      ...
      "item_already_reviewed" => "The item has already been reviewed!",
    ],
    'exception' => [
    ...
    'auth' => [
      ...
      "resend_verification_code" => "Verification code has been sent to your email address.",
