...
return [
  ...
  'resources' => [
    ...
    'role' => [
      ...
      'navigation_group' => 'التحكم في الوصول',
  ...
  'forms' => [
    'offer' => [
      ...
      'basic_information_description' => 'ارفع صورة العرض وحدد الحالة',
      'image' => 'صورة العرض',
      'status' => 'الحالة',
      'products_selection' => 'اختيار المنتجات',
      'products_selection_description' => 'اختر المنتجات مع المتغيرات والألوان المحددة لهذا العرض',
      ...
      'quantity' => 'الكمية',
      'discount' => 'الخصم',
      'discount_description' => 'حدد الخصم لهذا العرض',
      'products_total_price' => 'إجمالي سعر المنتجات',
      'products_total_price_help' => 'سيتم حساب هذا تلقائياً بناءً على المنتجات المحددة',
      'offer_price' => 'سعر العرض',
      'offer_price_help' => 'أدخل السعر النهائي لهذا العرض (سيتم حساب السعر الإجمالي تلقائياً)',
      'remove_product_confirm' => 'إزالة المنتج',
      'remove_product_description' => 'هل أنت متأكد من أنك تريد إزالة هذا المنتج من العرض؟',
      ...
      'offer_price_helper' => 'السعر بعد تطبيق الخصم',
    ],
    'coupon' => [
  ...
  'messages' => [
    ...
    'order' => [
      ...
      "buyer_not_found" => "المشتري غير موجود !",
      'order_undelivered' => 'الطلب مازال لم يتم تسليمه!',
    ...
    'review' => [
      ...
      "item_already_reviewed" => "العنصر قد تم تقييمه بالفعل!",
    ],
    'exception' => [
    ...
    'auth' => [
      ...
      "resend_verification_code" => "كود التحقق تم إرساله إلى بريدك الألكتروني.",
      "forgetPassword" => "إذا كان هذا البريد الإلكتروني موجودًا في نظامنا، فسوف تتلقى رابطًا لإعادة تعيين كلمة المرور قريبًا.",
      "user_not_found" => "المتستخدم غير موجود !",
      "user_undeleted" => "تعذر حذف المستخدم.",
    ],
    "favorite" => [
      "favorite_created" => "تمت إضافة المنتج إلى المفضلة بنجاح.",
      "favorite_not_found" => "لم يتم العثور على المفضلة.",
      "error_occurred" => "حدث خطأ ما!",
      "favorite_deleted" => "تمت إزالة المنتج من المفضلة بنجاح."
    ],
  ...
  // Validation Messages
  'validation' => [
    'variant_quantity_exceeds_stock' => 'كمية المتغير تتجاوز المخزون!',
